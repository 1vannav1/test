...
public class Main {
    ...
    private void reportForSwitcher() {
        ...
        try {
            PdfWriter.getInstance(document, new FileOutputStream("protocol_switcher_test.pdf"));
            document.open();
            ...
            // Добавляем заголовок
            Paragraph title = new Paragraph("ПРОТОКОЛ ПРОВЕРКИ ВЫКЛЮЧАТЕЛЯ", titleFont);
            title.setAlignment(Element.ALIGN_CENTER);
            document.add(title);
            ...
            // Добавляем форму проверки
            Paragraph checkForm = new Paragraph("Форма проверки: проверка выключателя.", dateFont);
            document.add(checkForm);
...
//            addTableRow(table2, rowData6Table2, dateFont);
    ...
    private void reportForProtection1X() {
        ...
        try {
            PdfWriter.getInstance(document, new FileOutputStream("protocol_protection1X.pdf"));
            document.open();
            ...
            // Добавляем заголовок
            Paragraph title = new Paragraph("ПРОТОКОЛ РЕЛЕЙНОЙ ЗАЩИТЫ (1Х)", titleFont);
            title.setAlignment(Element.ALIGN_CENTER);
            document.add(title);
            ...
            // Добавляем форму проверки
            Paragraph checkForm = new Paragraph("Форма проверки: проверка одной фазы релейной защиты.", dateFont);
            document.add(checkForm);

            // Добавляем вид повреждения
            Paragraph damageType = new Paragraph("Вид повреждения: ", dateFont);
            document.add(damageType);
...
//            addTableRow(table2, rowData6Table2, dateFont);
    ...
    private void reportForProtection3X() {
        ...
        try {
            PdfWriter.getInstance(document, new FileOutputStream("protocol_protection3X.pdf"));
            document.open();
            ...
            // Добавляем заголовок
            Paragraph title = new Paragraph("ПРОТОКОЛ РЕЛЕЙНОЙ ЗАЩИТЫ (3Х)", titleFont);
            title.setAlignment(Element.ALIGN_CENTER);
            document.add(title);
            ...
            // Добавляем форму проверки
            Paragraph checkForm = new Paragraph("Форма проверки: проверка трехфазной релейно защиты.", dateFont);
            document.add(checkForm);
...
//            addTableRow(table2, rowData6Table2, dateFont);
    ...
    private void reportForHand() {
        ...
        try {
            PdfWriter.getInstance(document, new FileOutputStream("protocol_hand.pdf"));
            document.open();
            ...
            // Добавляем заголовок
            Paragraph title = new Paragraph("ПРОТОКОЛ РУЧНОГО РЕЖИМА", titleFont);
            title.setAlignment(Element.ALIGN_CENTER);
            document.add(title);
            ...
            // Добавляем форму проверки
            Paragraph checkForm = new Paragraph("Форма проверки: ручной режим", dateFont);
            document.add(checkForm);
